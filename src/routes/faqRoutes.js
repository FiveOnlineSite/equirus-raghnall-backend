...
import { createFaq, deleteFaq, getAdminFaqs, getPublicFaqs, publishFaqs, reorderFaqs, updateFaq } from "../controllers/faqController.js";
...
adminFaqRouter.patch("/faqs/:page/publish", requireAdmin, publishFaqs);
